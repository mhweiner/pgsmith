...
**pgsmith** is a utility for safely building [parameterized SQL queries](https://node-postgres.com/features/queries#parameterized-query) for use with Postgres and [`pg`](https://github.com/brianc/node-postgres).
